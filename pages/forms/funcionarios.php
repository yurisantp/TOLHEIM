...
{ ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="../insere/inserirf.php" method="post">
                                 <div class="col-md-12">
                                                                       <label for="nomefunc">Nome</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomefunc" id="nomefunc" class="form-control" placeholder="Digite o nome do funcionario." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="loginfunc" id="loginfunc" class="form-control" placeholder="Digite o login do funcionario." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="password" name="senhafunc" id="senhafunc" class="form-control" placeholder="Digite a senha do produto." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="ruafunc" id="ruafunc" class="form-control" placeholder="Digite a rua do funcionario." maxlength="80">
                                    </div>
                                </div>
                                                                <label for="bairrofunc">Bairro</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="bairrofunc" id="bairrofunc" class="form-control" placeholder="Digite o bairro do funcionario." maxlength="80">
                                    </div>
                                </div>
                                                                <label for="cidadefunc">Cidade</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="cidadefunc" id="cidadefunc" class="form-control" placeholder="Digite a cidade do funcionario." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="numerofunc" id="numerofunc" class="form-control" placeholder="Digite o numero do funcionario." maxlength="80">
                                    </div>
                                </div>
                                   <label for="complementofunc">Complemento</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="complementofunc" id="complementofunc" class="form-control" placeholder="Digite o complemento do funcionario." maxlength="80">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control show-tick" data-live-search="true" name="estadofunc" required>
        ...
        <option value="to">Tocantins</option> 
                                 ...
                                 <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="datafunc" class="form-control date" placeholder="Ex: 30/07/2016">
                                            </div>
                                        </div>
 ...
 <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text"  name="celularfunc" class="form-control mobile-phone-number" placeholder="Ex: (00) 00000-0000">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="telefonefunc" class="form-control phone-number" placeholder="Ex: (00) 0000-0000">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="cepfunc" class="form-control cep-func" placeholder="Ex:  00000-000">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="cpffunc" class="form-control cpf-func" placeholder="Ex:  00000-000">
                                            </div>
                                        </div>
                                    </div>
<div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="rgfunc" class="form-control rg-func" placeholder="Ex:  00.000.000-X">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="salariofunc" id="salariofunc" OnKeyPress="formatar('#######.00', this)" class="form-control" placeholder="Ex: 99999999.99" maxlength="10">
                                    </div>
                                </div>
                                    </div>
                                    ...
                                    <select class="form-control show-tick" data-live-search="true" name="tipofunc">
...
<?php if($_SESSION['validar']['tipo'] == 'Administrador'){ ?>
         ...
         <?php if($_SESSION['validar']['tipo'] == 'Gerente'){ ?> 
           ...
           <?php  } ?>
                                    ...
                                    <select class="form-control show-tick" data-live-search="true" name="idempresafunc">
