                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <form action="../insere/inserird.php" method="post">
                                                                <div class="col-md-12">
                                <label for="nomedespesa">Nome</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomedespesa" id="nomedespesa" class="form-control" placeholder="Digite o nome da despesa." maxlength="45">
                                    </div>
                                </div>
                            </div>
...
<label for="valordespesa">Valor Despesa</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="valordespesa" id="valordespesa" OnKeyPress="formatar('#######.00', this)" class="form-control" placeholder="Ex: 99999999.99" maxlength="10">
                                    </div>
                                </div>
                                    </div>
                                    ...
                                    <select class="form-control show-tick" data-live-search="true" name="idempresadespesa">
