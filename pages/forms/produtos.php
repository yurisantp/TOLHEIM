            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="../insere/inserirp.php" method="post">
                                <label for="nomeproduto">Nome do Produto</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomeproduto" id="nomeproduto" class="form-control" placeholder="Digite o nome do produto." maxlength="45">
                                    </div>
                                </div>
                                <label for="nomeproduto">Descrição</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="descricaoproduto" id="descricaoproduto" class="form-control" placeholder="Digite a descrição do produto." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="estoqueproduto" id="estoqueproduto" class="form-control" placeholder="Digite a quantidade do produto." maxlength="80">
                                    </div>
                                </div>
                                                                                         <label for="nomeproduto">Valor</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="valorproduto" id="valorproduto" OnKeyPress="formatar('#######.00', this)" class="form-control" placeholder="Ex: 99999999.99" maxlength="10">
                                    </div>
                                </div>
