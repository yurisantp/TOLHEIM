...
{ ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="../insere/inserirc.php" method="post">
                                 <div class="col-md-12">
                                                                       <label for="nomecliente">Nome</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomeclientes" id="nomeclientes" class="form-control" placeholder="Digite o nome do cliente." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="emailclientes" id="emailclientes" class="form-control" placeholder="Digite Email do cliente." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="ruaclientes" id="ruaclientes" class="form-control" placeholder="Digite a rua do cliente." maxlength="80">
                                    </div>
                                </div>
                                                                <label for="bairrofunc">Bairro</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="bairroclientes" id="bairroclientes" class="form-control" placeholder="Digite o bairro do cliente." maxlength="80">
                                    </div>
                                </div>
                                                                <label for="cidadefunc">Cidade</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="cidadeclientes" id="cidadeclientes" class="form-control" placeholder="Digite a cidade do cliente." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="numeroclientes" id="numeroclientes" class="form-control" placeholder="Digite o numero do cliente." maxlength="80">
                                    </div>
                                </div>
                                   <label for="complementofunc">Complemento</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="complementoclientes" id="complementoclientes" class="form-control" placeholder="Digite o complemento do cliente." maxlength="80">
                                    </div>
                                </div>
                            </div>
 ...
 <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text"  name="celularclientes" class="form-control mobile-phone-number" placeholder="Ex: (00) 00000-0000">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="telefoneclientes" class="form-control phone-number" placeholder="Ex: (00) 0000-0000">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="cepclientes" class="form-control cep-func" placeholder="Ex:  00000-000">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="cpfclientes" class="form-control cpf-func" placeholder="Ex:  00000-000">
                                            </div>
                                        </div>
                                    </div>
