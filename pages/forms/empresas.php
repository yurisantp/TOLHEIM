...
if($_SESSION['validar']['tipo'] != "Administrador")
{
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="../insere/inserire.php" method="post">
                            <div class="col-md-12">
                                <label for="nomeempresa">Nome da Empresa</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomeempresa" id="nomeempresa" class="form-control" placeholder="Digite o nome da empresa." maxlength="45">
                                    </div>
                                </div>
                                <label for="nomeempresa">Responsavel</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="responsavelempresa" id="nomeempresa" class="form-control" placeholder="Digite o responsavel pela empresa." maxlength="80">
                                    </div>
                                </div>
                              ...
                              <label for="nomeempresa">Endereço</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="enderecoempresa" id="enderecoempresa" class="form-control" placeholder="Digite o endereço da empresa." maxlength="80">
                                    </div>
                                </div>
                                </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="telefoneempresa" class="form-control phone-number" placeholder="Ex: (00) 0000-0000">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                             ...
                             <label for="cnpjempresa">CNPJ</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="cnpjempresa" id="cnpjempresa" class="form-control" placeholder="Digite o CNPJ da empresa." maxlength="80">
                                    </div>
                                </div>
                                </div>
