...
<head>
    ...
    <title>Produtos - Tolheim ADMIN</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="produtos2.php" method="post">

                                                                <label for="idproduto">ID</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="idproduto" value="<?php echo $dados['ID']; ?>" id="idproduto" class="form-control" placeholder="Digite o nome do produto." maxlength="45">
                                    </div>
                                <label for="nomeproduto">Nome do Produto</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomeproduto" value="<?php echo $dados['NOME']; ?>" id="nomeproduto" class="form-control" placeholder="Digite o nome do produto." maxlength="45">
                                    </div>
                                </div>
                                <label for="nomeproduto">Descrição</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="descricaoproduto" value="<?php echo $dados['DESCRICAO']; ?>" id="descricaoproduto" class="form-control" placeholder="Digite a descrição do produto." maxlength="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="estoqueproduto" value="<?php echo $dados['QUANTIDADE']; ?>" id="estoqueproduto" class="form-control" placeholder="Digite a quantidade do produto." maxlength="80">
                                    </div>
                                </div>
                                                                                         <label for="nomeproduto">Valor</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="valorproduto" value="<?php echo $dados['VALOR']; ?>" id="valorproduto" OnKeyPress="formatar('#######.00', this)" class="form-control" placeholder="Ex: 99999999.99" maxlength="10">
                                    </div>
                                </div>
                                    ...
                                    <select class="form-control show-tick" data-live-search="true" name="idempresaproduto">
