...
$sql = "select * from venda where ID = '".$_GET['id']."'";
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="../../pages/charts/produtos.php">Produtos</a>
                                                        ...
                                                        <li>
                                <a href="../../pages/charts/vendas.php">Vendas</a>
                            </li>
                                                        <li>
                                <a href="../../pages/charts/funcionarios.php">Funcionarios</a>
                            </li>
                                                        <li>
                                <a href="../../pages/charts/despesas.php">Despesas</a>
                            </li>
                            <li>
                                <a href="../../pages/charts/clientes.php">Clientes</a>
                            </li>
                            <li>
...
<?php if($dadosp) : ?>
      ...
      <?php foreach($dadosp as $produto) : ?>
        ...
        <tr>
          ...
          <td><input type="text" id="valorproduto"  class="form-control"  type="number" name="<?php echo $produto['ID']; ?>" placeholder="Quantidade" min="0" max="<?php echo $produto['QUANTIDADE']; ?>"></td>
