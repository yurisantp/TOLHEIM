...
$sql = "select * from despesa where ID = '".$_GET['id']."'";
...
<head>
    ...
    <title>Despesas - Tolheim ADMIN</title>
...
{ ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <form action="despesas2.php" method="post">
                                                                <div class="col-md-12">
                                <label for="iddespesa">ID</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="iddespesa" value="<?php echo $dados['ID']; ?>" id="iddespesa" class="form-control" placeholder="Digite o nome da despesa." maxlength="45">
                                    </div>
                                </div>

                                <label for="nomedespesa">Nome</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="nomedespesa" value="<?php echo $dados['NOME']; ?>" id="nomedespesa" class="form-control" placeholder="Digite o nome da despesa." maxlength="45">
                                    </div>
                                </div>
                            </div>
 ...
 <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="datafunc" value="<?php echo $dados['DATA_VENCIMENTO']; ?>" class="form-control date" placeholder="Ex: 30/07/2016">
                                            </div>
                                        </div>
...
<label for="valordespesa">Valor Despesa</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="valordespesa" id="valordespesa" value="<?php echo $dados['VALOR']; ?>" OnKeyPress="formatar('#######.00', this)" class="form-control" placeholder="Ex: 99999999.99" maxlength="10">
                                    </div>
                                </div>
                                    </div>
                                    ...
                                    <select class="form-control show-tick" value="<?php echo $dados['EMPRESA_ID']; ?>" data-live-search="true" name="idempresadespesa">
