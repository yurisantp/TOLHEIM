...
$sql = "SELECT count(*) FROM venda AS nm WHERE CLIENTE_CPF = '".$cliente['CPF']."'"; 
...
$sql = "SELECT sum(VALOR) FROM venda AS nmd WHERE CLIENTE_CPF = '".$cliente['CPF']."'"; 
...
<td><a href="../alterar/clientes.php?id=<?php echo $cliente['ID']; ?>"" name="salvar" class="btn btn-info">Alterar</a></td>
