    ...
    <section class="content">
      ...
      <?php foreach($dadosd as $despesa) : ?>
        ...
        <tr>
          ...
          <td><?php $datafunc = $despesa["DATA_VENCIMENTO"];

$sqlDate = date("d/m/Y",strtotime($datafunc));  echo $sqlDate; ?></td>


 <td>  <a href="../excluir/despesas.php?id=<?php echo $despesa['ID']; ?>" class="btn btn-danger">Excluir</a></td>
<td><a href="../alterar/despesas.php?id=<?php echo $despesa['ID']; ?>"" name="salvar" class="btn btn-info">Alterar</a></td>
