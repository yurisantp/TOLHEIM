...
{ ?>
 ...
 <?php if($dadosf) : ?>
      ...
      <?php foreach($dadosf as $funcionario) : ?>
        ...
        <tr>
          ...
          <td><?php echo $funcionario['CPF']; ?></td>
                    <td><?php echo $funcionario['CELULAR']; ?></td>
                              <td><?php $datafunc = $funcionario["DATA_ADMISSAO"];
...
$sql = "select * from usuario where funcionario_id = '".$funcionario['ID']."'"; 

                        $resulti = $con->query($sql);
if($resulti->num_rows > 0){
   
   $dadosu=$resulti->fetch_assoc();
...
$sql = "SELECT count(*) FROM venda AS nm WHERE FUNCIONARIO_ID = '".$funcionario['ID']."'"; 

            $v = $con->query($sql);

        $vf = mysqli_fetch_assoc($v);

                if(empty($vjanf['count(*)'])){
...
$sql = "SELECT sum(VALOR) FROM venda AS nmd WHERE FUNCIONARIO_ID = '".$funcionario['ID']."'"; 
...
$vf['sum(VALOR)'] = 0;
        ...
        echo $vf['sum(VALOR)'];
?></td>
<td><a href="../alterar/funcionarios.php?id=<?php echo $funcionario['ID']; ?>"" name="salvar" class="btn btn-info">Alterar</a></td>
