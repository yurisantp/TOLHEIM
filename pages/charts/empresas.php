...
{ ?>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div id="bar_chart" class="graph"></div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h4>Obs: É selecionado toda receita e despesa da empresa.</h4></div>            
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../../js/pages/charts/empresas.php"></script>
