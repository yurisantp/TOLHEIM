...
{ ?>
        ...
        <div class="container-fluid">
            ...
            <!-- Exportable Table -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>PORCENTAGEM DE PRODUTO MAIS RENTAVEL</h2>
                        ...
                        <div class="body">
                            <div id="donut_chart" class="graph"></div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h4>Obs: É selecionado o produto que mais rendeu para a empresa.</h4></div>            
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../../js/pages/charts/produtos.php"></script>
