$(function () {
    ...
    $demoMaskedInput.find('.cpf-func').inputmask('999.999.999-99', { placeholder: '___.___.___-__' });

        $demoMaskedInput.find('.cep-func').inputmask('99999-999', { placeholder: '_____-___' });

                $demoMaskedInput.find('.rg-func').inputmask('99.999.999-99', { placeholder: '__.___.___-__' });

                                $demoMaskedInput.find('.salario-func').inputmask('9999999.99', { placeholder: '_______.__' });


    //Dollar Money
    $demoMaskedInput.find('.money-dollar').inputmask('9999999.99', { placeholder: '' });
    //Euro Money
